...
<section class="py-10 flex flex-col items-center lg:py-24" id="pricing">
    ...
    <div class="w-full flex flex-col items-center md:items-end md:flex-row md:justify-between md:space-x-2 lg:w-3/4">
        ...
        <div class="mt-4 md:mt-24 bg-brand-gray-500 border-2 border-brand-gray-600 rounded-xl flex flex-col justify-between p-4 w-11/12 md:w-1/3">
            ...
            <a class="w-full text-xl block text-center font-extrabold text-brand-white bg-gradient-to-r from-brand-gray-400 to-brand-gray-900 px-4 py-2 rounded-xl mt-8" href="#">Get Basic</a>
        </div>

        {{-- Premium Card --}}
        <div class="w-11/12 mt-4 md:mt-0 md:w-5/12 lg:w-1/3 flex flex-col justify-between rounded-xl bg-gradient-to-r from-[#F26687] to-[#AD3391] p-4">
            <div>
            ...
            <a class="mt-8 text-xl bg-brand-white bg-opacity-20 w-full block rounded-xl text-center py-2 text-brand-white font-extrabold" href="#">Get Premium</a>
        </div>

        {{-- Enterprise Card --}}
        <div class="w-11/12 mt-4 md:mt-24 flex flex-col justify-between bg-brand-gray-500 border-2 border-brand-gray-600 rounded-xl p-4 md:w-1/3">
            <div>
            ...
            <a class="text-center text-xl font-extrabold text-brand-white bg-gradient-to-r from-brand-gray-400 to-brand-gray-900 px-4 py-2 rounded-xl mt-8" href="#">Get Basic</a>
        </div>
    </div>
</section>
