...
<section class="py-10" id="pricing">
    ...
    <div class="w-full flex flex-col items-center md:flex-row md:justify-between md:space-x-2">
        <div class="mt-4 md:mt-24 bg-brand-gray-500 border-2 border-brand-gray-600 rounded-xl flex flex-col justify-between p-4 w-11/12 md:w-1/3">
            ...
            <a class="w-full block text-center font-extrabold text-brand-white bg-gradient-to-r from-brand-gray-400 to-brand-gray-900 px-4 py-2 rounded-xl mt-8 md:mt-0" href="#">Get Basic</a>
        </div>
        <div class="w-11/12 mt-4 md:mt-0 md:w-5/12 flex flex-col justify-between rounded-xl bg-brand-primary-500 p-4">
            <div>
        ...
        <div class="w-11/12 mt-4 md:mt-24 flex flex-col justify-between bg-brand-gray-500 border-2 border-brand-gray-600 rounded-xl p-4 md:w-1/3">
            ...
            <a class="text-center font-extrabold text-brand-white bg-gradient-to-r from-brand-gray-400 to-brand-gray-900 px-4 py-2 rounded-xl mt-8 md:mt-0" href="#">Get Basic</a>
        </div>
    </div>
</section>
